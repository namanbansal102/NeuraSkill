...
const testimonials = [
  ...
  {
    quote:
      "With open-source transparency, NeuraSkill eliminates biases in project selection, ensuring fair competition through AI-powered ranking and QIE-based voting.",
    name: "Nick Szabo",
